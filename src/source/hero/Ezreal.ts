function importModule() {
  return {
    ...
    spells: [
      { id: "EzrealP", name: "咒能高涨", icon: "EzrealP.png", description: "" },
      { id: "EzrealQ", name: "秘术射击", icon: "EzrealQ.png", description: "" },
      { id: "EzrealW", name: "精华跃动", icon: "EzrealW.png", description: "" },
      { id: "EzrealE", name: "奥术跃迁", icon: "EzrealE.png", description: "" },
      { id: "EzrealR", name: "精准弹幕", icon: "EzrealR.png", description: "" },
    ],
    effects: {
      EzrealP: null,
      EzrealQ: null,
