function importModule() {
  return {
    ...
    spells: [
      { id: "RivenP", name: "符文之刃", icon: "RivenP.png", description: "" },
      { id: "RivenQ", name: "折翼之舞", icon: "RivenQ.png", description: "" },
      { id: "RivenW", name: "震魂怒吼", icon: "RivenW.png", description: "" },
      { id: "RivenE", name: "勇往直前", icon: "RivenE.png", description: "" },
      { id: "RivenR", name: "放逐之锋", icon: "RivenR.png", description: "" },
    ],
    effects: {
      RivenP: null,
      RivenQ: null,
